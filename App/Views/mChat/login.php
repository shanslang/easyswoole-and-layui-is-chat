...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Static/asset/layui/css/layui.mobile.css" />
    ...
    <div class="content">
        <div id="large-header" class="large-header">
            ...
            <div class="logo_box">
                ...
                <p style="text-align: center;">还没有账号？立即<a style="color: #cccccc;" href="/Chat/Chat/register"> 注册 </a></p>
            </div>
        </div>
    </div>
</div><!-- /container -->
            ...
            $.ajax({
                ...
                success:function(res){
                    if(res.code == 200){
                        ...
                        setTimeout(function(){
                            window.location = "/Chat/Chat/index?token="+res.data.token;
                       },1500);
                    }else{
                        console.log(res);
